...
This repository contains the files for the development of the project for classification of glaucoma into healthy and normal cases. It uses public databases for training models for both kind of images defined (Color Fundus Photography and Optical Coherence Tomography) and two external databases which contain pairs of images of the same patient.
